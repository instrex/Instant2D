...
/// <summary>
/// Generic collision shape interface. Also contains various useful collision check functions.
/// </summary>
public partial interface ICollisionShape {
    ...
    /// </summary>
    bool CollidesWithLine(Vector2 start, Vector2 end, out float distance, out Vector2 intersectionPoint, out Vector2 normal);
